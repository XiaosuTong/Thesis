...
As analyst, we only need to specify R code to carry out a D\&R job
\begin{itemize}
\item divide the whole dataset into subsets
\item apply the analytic method to each subset
