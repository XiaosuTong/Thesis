...
observations to predict 36 oncoming observations, then move the time window of 
training dataset one observation ahead, 2nd to 271st observation, and predict the
next 36 observations. There are 576 observations for each station, so we conduct 
271 replicates for prediction of 36 observations within each station.

Moreover, we want to find the best parameter set based on
