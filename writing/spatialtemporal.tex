...
the standard deviation of prediction error over 271 replicates for a given 
station given lag distance is plotted against lag distance conditional on $w_s$
...
deviation of prediction error against to lag distance conditional on $w_t$ and
superposed on $w_s$ as well.
