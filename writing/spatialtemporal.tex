...
Figure 
\href{../plots/a1950/E3/tmax.mean.absmeans.vs.lag.td.pdf}{\ref*{e3.abserrorlag.td}} 
and Figure 
\href{../plots/a1950/E3/tmax.std.vs.lag.td.pdf}{\ref*{e3.stderrorlag.td}} 
illustrate that mean of absolute prediction error and standard deviation error
is minimized and become stable after $w_t$ is larger than 123. Moreover, when
