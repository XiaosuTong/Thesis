...
only because the 688 stations got missing observation on Jan 1982, but then they
...
As shown in Figure \href{../plots/obs_month_byseason.pdf}{\ref*{obs.month.season}}
\begin{framed}
\begin{center}
  \href{../plots/obs_month_byseason.pdf}{Link to figure}
  \captionof{figure}{The number of observations for Three Months}
