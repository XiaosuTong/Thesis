...
\begin{description}
  ...
  unique \texttt{station.id} as the key, and a R data.frame as the value. The value includes (1) \texttt{year}, year of the observation, (2) \texttt{month}, month 
...
This section will talked about how the trend components look like and how to judge if the
fit is good or not with respect to the trend.
