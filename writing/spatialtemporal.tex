...
polynomials for both seasonal and trend components. The smoothing span for seasonal
...
temporal seasonality. Next, we carry out the diagnostics for each components based on corresponding diagnostic plots.

Figure \href{}{\ref*{}} is called $seasonal$ $fitted$ $values$ $plot$, in which
seasonal plus remainder component with mean of seasonal subtracted is drawn 
against to year. 
